...
const CandidateDetail = () => {
  ...
  return (
    <div className="p-4 sm:p-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        ...
        <div className="flex gap-4 sm:gap-[200px] w-full sm:w-auto justify-between sm:justify-end">
          <a 
            href={candidate.resume} 
            download
            className="flex items-center gap-1 text-sm sm:text-base transition-transform duration-300 hover:translate-x-1"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
              <path fill="#2C2C2C" d="M6,2A2,2 0 0,0 4,4V20A2,2 0 0,0 6,22H18A2,2 0 0,0 20,20V8L14,2H6M6,4H13V9H18V20H6V4M8,12V14H16V12H8M8,16V18H13V16H8Z"/>
            </svg>
            <span>Resume-name.pdf/.doc</span>
            <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path fill="#2C2C2C" d="M8 17V15H16V17H8M16 10L12 14L8 10H10.5V7H13.5V10H16M5 3H19C20.11 3 21 3.9 21 5V19C21 20.11 20.11 21 19 21H5C3.9 21 3 20.11 3 19V5C3 3.9 3.9 3 5 3M5 5V19H19V5H5Z"/>
            </svg>
          </a>
          <button 
            onClick={() => navigate('/')}
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
              <path fill="#2C2C2C" d="M7,12L12,7V10H16V14H12V17L7,12M21,5V19A2,2 0 0,1 19,21H5A2,2 0 0,1 3,19V5A2,2 0 0,1 5,3H19A2,2 0 0,1 21,5M19,5H5V19H19V5Z"/>
            </svg>
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        <div className="flex-1">
          ...
          <div className="mb-6">
            ...
            <div className="bg-gray-50 rounded p-3 sm:p-4 custom-shadow">
          ...
          <div>
            ...
            <div className="flex-1 bg-gray-50 rounded p-3 sm:p-4 custom-shadow">
  ...
  <p className="text-gray-700 bg-white p-3 sm:p-4 rounded text-sm sm:text-base leading-relaxed">
    ...
    Responsibility was to manage the organization's product solutions and design, while also providing guidance and assistance to two junior designers. I designed two mobile apps and multiple responsive websites.
        ...
        <div className="w-full lg:w-80">
          <div className="flex gap-2 items-center mb-3">
            ...
            <button className="text-blue-600 transition-transform duration-300 hover:translate-x-1">
              <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <path fill="#2C2C2C" d="M19,19V5H5V19H19M19,3A2,2 0 0,1 21,5V19C21,20.11 20.1,21 19,21H5A2,2 0 0,1 3,19V5A2,2 0 0,1 5,3H19M16.7,9.35L15.7,10.35L13.65,8.3L14.65,7.3C14.86,7.08 15.21,7.08 15.42,7.3L16.7,8.58C16.92,8.79 16.92,9.14 16.7,9.35M7,14.94L13.06,8.88L15.12,10.94L9.06,17H7V14.94Z"/>
              </svg>
            </button>
          </div>
          <textarea 
            className="w-full h-[300px] lg:h-[calc(100vh-250px)] p-4 border rounded resize-none custom-shadow text-sm sm:text-base"
