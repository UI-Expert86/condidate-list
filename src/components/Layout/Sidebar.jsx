...
const Sidebar = () => {
  return (
    <div className="w-60 bg-[#1f2a37] h-screen">
           <NavLink 
        to="/" 
       className='bg-[#1f2a37] text-white flex items-center gap-2 p-4'
      >
  ...
  <path fill='#fff' d="M19,5V7H15V5H19M9,5V11H5V5H9M19,13V19H15V13H19M9,17V19H5V17H9M21,3H13V9H21V3M11,3H3V13H11V3M21,11H13V21H21V11M11,15H3V21H11V15Z"/>
      ...
      <NavLink 
        to="/" 
        className="flex items-center gap-2 p-4 bg-[#D0E4FE] text-[#1863dc] font-semibold"
      >
        <svg class="w-6 h-6 fill-current text-[#1863dc] hover:text-[#1863dc]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
